...
var ErrTensorRTNotAvailable = errors.New("gpu: TensorRT not available (build without tensorrt tag)")
...
// The stream parameter is uintptr to avoid cgo dependency in the stub.
