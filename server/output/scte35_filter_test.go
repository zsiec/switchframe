...
func TestSCTE35Filter_EmptyAfterFiltering(t *testing.T) {
	...
	var data []byte
	data = append(data, makeTSPacketFill(scte35PID, 0xAA)...)
	data = append(data, makeTSPacketFill(scte35PID, 0xBB)...)
...
func TestSCTE35Filter_MultipleSCTE35Packets(t *testing.T) {
	...
	data = append(data, makeTSPacketFill(scte35PID, 0x22)...) // strip
	data = append(data, makeTSPacketFill(scte35PID, 0x33)...) // strip
	data = append(data, makeTSPacketFill(0x101, 0x44)...)     // audio
	data = append(data, makeTSPacketFill(scte35PID, 0x55)...) // strip
