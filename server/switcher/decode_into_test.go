...
func TestDecodeInto_DirectWriteSkipsCopy(t *testing.T) {
	...
	sd := newSourceDecoder("cam-test", factory, callback, pool, nil, nil, nil)
	defer sd.Close()
...
func TestDecodeInto_FallbackWhenPoolTooSmall(t *testing.T) {
	...
	sd := newSourceDecoder("cam-test-small", factory, callback, pool, nil, nil, nil)
	defer sd.Close()
...
func TestDecodeInto_FallbackForNonDecodeIntoDecoder(t *testing.T) {
	...
	sd := newSourceDecoder("cam-fallback", factory, callback, pool, nil, nil, nil)
	defer sd.Close()
...
func TestDecodeInto_NilPool(t *testing.T) {
	...
	sd := newSourceDecoder("cam-nopool", factory, callback, nil, nil, nil, nil)
	defer sd.Close()
