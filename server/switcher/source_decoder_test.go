...
func TestSourceDecoderCreation(t *testing.T) {
	...
	sd := newSourceDecoder("cam1", factory, callback, nil, nil, nil, nil)
	if sd == nil {
...
func TestSourceDecoderFactoryError(t *testing.T) {
	...
	sd := newSourceDecoder("cam1", factory, func(string, *ProcessingFrame) {}, nil, nil, nil, nil)
	if sd != nil {
		sd.Close()
...
func TestSourceDecoderPipelineFormat(t *testing.T) {
	...
	sd := newSourceDecoder("cam1", factory, callback, nil, &pf, nil, nil)
	if sd == nil {
		t.Fatal("newSourceDecoder returned nil")
	}
	defer sd.Close()
...
func TestSourceDecoderPipelineFormatScaleBuf(t *testing.T) {
	...
	sd := newSourceDecoder("cam1", factory, func(string, *ProcessingFrame) {}, nil, &pf, nil, nil)
	if sd == nil {
		t.Fatal("newSourceDecoder returned nil")
	}
	defer sd.Close()
...
func TestSourceDecoder_PipelineFormatChangeUpdatesScaling(t *testing.T) {
	...
	sd := newSourceDecoder("cam1", factory, callback, nil, &pfPtr, nil, nil)
	if sd == nil {
		t.Fatal("newSourceDecoder returned nil")
	}
	defer sd.Close()
...
func TestSourceDecoderPoolDimensionMismatch(t *testing.T) {
	...
	sd := newSourceDecoder("cam1", factory, callback, pool, nil, nil, nil)
	if sd == nil {
		t.Fatal("newSourceDecoder returned nil")
	}
	defer sd.Close()
